...
const Ethics = ( props ) => {
  ...
  React.useEffect(() => props.timer(5, 0, false), []);

  return(
    <Frame frameTitle="Information for participants">
      <p><b>Nature of the study.&nbsp;</b>You are about to participate in an experiment in which you will use your scientific investigation skills. After the experiment, we will ask you to provide some basic demographics (e.g., age). Your session should last up for around 30 minutes and your responses will be recorded. You will be given full instructions shortly and will be able to ask any questions you may have.</p>
          <p><b>Compensation.&nbsp;</b> You will be paid $4 for your participation upon completion. The maximum additional bonus that can be granted is $2.</p>
